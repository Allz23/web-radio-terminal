$(document).ready(function() {
  ...
  $("#fechaCheck").on("click", function() {
    if (this.checked === true) {
      ...
      sesionCheck.prop({ disabled: true, checked: false });
      nombreCheck.prop({ disabled: true, checked: false });
    } else {
      datePicker.toggleClass("disabled");
      datePicker.prop("disabled", true);
      sesionCheck.prop({ disabled: false, checked: false });
      nombreCheck.prop({ disabled: false, checked: false });
    }
  });
  ...
  $("#sesionCheck").on("click", function() {
    if (this.checked === true) {
      ...
      // Al seleccionar, deshabilitamos los demas checkboxes, y les quitamos la propiedad 'checked'
      fechaCheck.prop({ disabled: true, checked: false });
      nombreCheck.prop({ disabled: true, checked: false });
    } else {
      selectSesion.toggleClass("disabled");
      selectSesion.prop("disabled", true);
      fechaCheck.prop({ disabled: false, checked: false });
      nombreCheck.prop({ disabled: false, checked: false });
    }
  });
